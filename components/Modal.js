                    ...
                    <div className="text-[#6e767d] flex gap-x-3 relative">
                        ...
                        <div>
                            <div className="inline-block group">
                                <h4 className="font-bold text-[#d9d9d9] inline-block text-[15px] sm:text-base group-hover:underline">{post?.username}</h4>
                      ...
                      <img className="rounded-2xl max-h-[200px] object-cover mr-2 mt-4" src={post?.image} alt=""/>
                        </div>
                    </div>
